...
export default class TaskController {
    ...
    public createTask(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    ...
    public updateTask(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
        let userId = request.auth.credentials.id;
    ...
    public deleteTask(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
        let id = request.params["id"];
        let userId = request.auth.credentials.id;
    ...
    public getTaskById(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
        let userId = request.auth.credentials.id;
        let id = request.params["id"];
    ...
    public getTasks(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
        let userId = request.auth.credentials.id;
