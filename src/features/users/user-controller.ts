...
export default class UserController {
    ...
    public loginUser(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    ...
    public createUser(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    ...
    public infoUser(request: Hapi.Request, reply: Hapi.ReplyNoContinue) {
        const id = request.auth.credentials.id;
